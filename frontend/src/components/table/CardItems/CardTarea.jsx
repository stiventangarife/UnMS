...
const CardTarea = ({ item, onEdit, onView, onDelete, onSwitchChange, isActive }) => {
    ...
    return (
        <div className={`rounded-lg ml-4 p-4 mb-4 ${cardClass}`}>
            ...
            <div className="flex items-center mb-2">
                ...
                <span className="ml-2">{item.accion}</span>
            </div>
            <div className="flex items-center mb-2">
                <span className="font-semibold">Horas</span>
                <span className="ml-2">{item.cantidadHoras}</span>
            </div>
            <div className="flex items-center mb-2">
            ...
            <div className="flex justify-between m-2 ">
                ...
                <button
                    ...
                    title={item.estado !== 'activo' ? 'No se puede editar una tarea inactiva' : ''}
                >
                    <RiPlaneFill />
                </button>
                <button
                    ...
                    disabled={item.estado !== 'activo'}
                    title={item.estado !== 'activo' ? 'No se puede eliminar una tarea inactiva' : ''}
                >
                    <RiDeleteBin6Line />
                </button>
            </div>
